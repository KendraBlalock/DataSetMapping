...
I choose a distinctive symbol to represent each of the different data tables (internal sources, external sources, intermediary tables, and final tables), as well as for SQL vs. R scripts.
...
-	28 R scripts
  ...
  -	509 pipping symbols used (%>%)
  -	1277 assignment operators used (<-)


From there I adopted the same approach for a new project which is still currently underway.

![](Screenshot 2022-05-11 093007.png)
